...
<body style="background-color: #f2f9fd;">
	<div class="header bg-main">
		...
		<div class="head-l">
			...
			<a class="button button-little bg-blue"> <span class="icon-login"></span>
				...
				href="comloginsuccess.jsp"> <span class="icon-home"></span> 后台首页
	...
	<%
		...
		String Url = "UpdateInfo.jsp?compid=" + userid.getUserid();
		String LookEmpInfo = "LookEmpInfo.jsp";
		String LookUrl = "LookInfo.jsp?compid=" + userid.getUserid();
	%>
	...
	<div class="leftnav">
		...
		<h2>
			<span class="icon-pencil-square-c"></span>企业信息管理
		</h2>
		<ul>
			<li><a href="<%=Url%>" target="right"><span
					class="icon-caret-right"></span>企业信息完善</a></li>

		</ul>

		<h2>
			<span class="icon-pencil-square-o"></span>招聘信息管理
		</h2>
		<ul>
			<li><a href="<%=LookEmpInfo%>" target="right"><span
					class="icon-caret-right"></span>查看应聘信息</a></li>
			<li><a href="addJob.jsp" target="right"><span
					class="icon-caret-right"></span>发布招聘信息</a></li>
		</ul>

		<h2>
			<span class="icon-user"></span>企业信息维护
		</h2>
		<ul>
			<li><a href="<%=LookUrl%>" target="right"><span
					class="icon-caret-right"></span>企业简介</a></li>
