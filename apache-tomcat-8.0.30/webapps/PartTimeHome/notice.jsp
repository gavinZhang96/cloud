...
<body>
	...
	<div class="index_case_banner index_public">
		<img src="images/xt.gif" alt="">
	</div>
	<!-- main -->
	<div class="case_main index_public" style="height: 400px">
		<section class="case_left"> <footer class="case_left_t">
		<span class="case_left_t1">留言操作</span> <span class="case_left_t2">Message
			Operation</span> </footer>
		<ul class="case_left_ul1">
			<li><a href="msglook.jsp" class="case_left_li_on" target="right">留言板</a></li>
			<li><a href="addnotice.jsp" class="case_left_li_on"
				target="right">发布留言</a></li>
		</ul>
		</section>
		...
		<div class="case_right_box1" style="height: 370px">
			<iframe style="border: 0px;" name="right" width="100%" height="100%"
				frameborder="1" scrolling="auto" src="msglook.jsp"> </iframe>
		</div>
		</section>
		<div class="clear"></div>
	</div>
